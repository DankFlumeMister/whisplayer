...
abstract final class AppTheme {
  ...
  static const List<ThemePalette> palettes = <ThemePalette>[
    ...
    (name: '莓红', seed: Color(0xFFAD1457)),
    (name: '珊瑚', seed: Color(0xFFF4511E)),
    (name: '落日', seed: Color(0xFFFF6D00)),
    ...
    (name: '翡翠', seed: Color(0xFF2E7D32)),
    (name: '青瓷', seed: Color(0xFF00897B)),
    (name: '湖水', seed: Color(0xFF26C6DA)),
    (name: '碧空', seed: Color(0xFF039BE5)),
    (name: '晴空', seed: Color(0xFF1E88E5)),
    (name: '鸢尾', seed: Color(0xFF5C6BC0)),
    (name: '黛蓝', seed: Color(0xFF3949AB)),
    (name: '石板', seed: Color(0xFF455A64)),
    (name: '墨青', seed: Color(0xFF546E7A)),
    (name: '咖啡', seed: Color(0xFF6D4C41)),
    (name: '薰衣草', seed: Color(0xFF7E57C2)),
    (name: '紫藤', seed: Color(0xFF8E24AA)),
    (name: '绛紫', seed: Color(0xFF6A1B9A)),
    (name: '洛神', seed: Color(0xFFF06292)),
  ];
